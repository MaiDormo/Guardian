...
export default function FallBanner({ fall, onDismiss }: FallBannerProps) {
  ...
  return (
    <div className="slide-down mb-lg">
      <div className="bg-error text-on-error p-4 rounded-xl flex items-center justify-between shadow-lg">
        ...
        <button
          onClick={onDismiss}
          className="bg-on-error/20 text-on-error p-2 rounded-full hover:bg-on-error/30 transition-colors"
        >
          <X size={20} />
        </button>
      </div>
